...
if [[ $projectDir && -d $projectDir ]];then
    ...
    rest-api-version="v2.2.0"
    rest-client-version="v2.2.1"
    #build php
    ...
    sudo docker build ./rest-client-node -t linBox:5000/restnode:${rest-api-version}
    sudo docker build ./rest-api-dotnet -t linBox:5000/restdotnet:${rest-client-version}
